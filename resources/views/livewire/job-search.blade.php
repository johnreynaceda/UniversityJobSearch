                ...
                <div>
                    ...
                    <div class="border border-gray-300 mt-3 flex space-x-2 items-center p-2 px-5 rounded-full">
                        ...
                        <input type="text" name="" placeholder="Search OJTs"
                            ...
                            id="">
                        <button class="p-2 px-6 rounded-full font-bold text-lg bg-main hover:bg-red-600  text-white">
                            <span>SEARCH</span>
                        </button>
                    </div>
                </div>
                <div>
                    <h1 class="text-2xl text-gray-500">Looking for <span class="text-green-600 font-bold">Work</span>?
                    </h1>
                    <div class="border border-gray-300 mt-3 flex space-x-2 items-center p-2 px-5 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-gray-400" viewBox="0 0 24 24"
                            fill="currentColor">
