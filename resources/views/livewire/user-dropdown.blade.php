<div class="flex space-x-4 items-center">
    ...
    <div x-show="open"  x-cloak class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-sm overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
        <div class="p-2">
          @forelse ($notifs as $item)
          <div class="group relative flex items-center cursor-pointer gap-x-2 rounded-lg text-sm leading-6 hover:bg-gray-50">
            <div class="flex h-8 w-8 flex-none items-center justify-center text-main rounded-lg bg-gray-100 group-hover:bg-white">
